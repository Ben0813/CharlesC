...
const ServicesPage = () => {
  ...
  useEffect(() => {
    axios.get(`${import.meta.env.VITE_REACT_APP_API_URL}/services`)
      .then(response => {
        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service) => (
              <div key={service.id} className="p-6 bg-white bg-opacity-80 border rounded-md shadow-md hover:shadow-xl transition-shadow duration-300 max-w-md w-full">
