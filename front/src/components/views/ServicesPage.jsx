      ...
      <div className="container mx-auto p-4 mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-center">
          {services.map((service, index) => (
            <div key={index} className="p-6 bg-white bg-opacity-80 border rounded-md shadow-md hover:shadow-xl transition-shadow duration-300 max-w-md mx-auto">
              <h2 className="font-display text-2xl mb-2 text-gray-900">{service.title}</h2>
              <p className="text-xl font-bold mb-4 text-gay-800">{service.price}</p>
